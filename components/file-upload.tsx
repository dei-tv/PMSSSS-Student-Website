...
export const FileUpload = ({
    ...
    return (
        <div className="flex w-full flex-col items-center" {...getRootProps()}>
            <motion.div
                onClick={handleClick}
                whileHover="animate"
          ...
          <GridPattern />
                ...
                <div className="flex flex-col items-center justify-center">
                    ...
                    <div className="relative mx-auto mt-10 w-full max-w-xl rounded-lg border border-dashed border-white/10 p-2">
                        {files.length > 0 &&
                            files.map((file, idx) => (
                                <motion.div
                                    key={'file' + idx}
            ...
            {files.length > 0 && (
                <button
                    ...
                    className="mt-4 w-1/3 self-center rounded-md bg-blue-500 py-2 text-white hover:bg-blue-600"
                >
                    Submit Files
                </button>
            )}
