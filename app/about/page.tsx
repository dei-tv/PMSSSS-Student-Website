                    ...
                    <div className="container grid items-center gap-6 px-4 md:px-6 lg:grid-cols-2 lg:gap-10">
                        <div className="space-y-2">
                            ...
                            <p className="max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                                The PMSSS provides access to top-tier
                                educational institutions, enabling students to
                                pursue their dreams and unlock their full
                                potential. From prestigious universities to
                                specialized programs, the scheme opens doors to
